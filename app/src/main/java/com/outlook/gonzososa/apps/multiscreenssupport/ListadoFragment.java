...
public class ListadoFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof TouchListener) {
            listener = (TouchListener) context;
        } else {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter (new  ListadoAdapter (getContext (), names, images,listener));
    }
}
...
class ListadoAdapter extends RecyclerView.Adapter<ListadoViewHolder> {
    ...
    ListadoAdapter (Context context, ArrayList<String> myData, ArrayList<Drawable> myImages, TouchListener listener) {
    ...
    public void onBindViewHolder (@NonNull ListadoViewHolder listadoViewHolder, int i) {
        ...
        listadoViewHolder.itemView.setOnClickListener(view -> {
            if (listener != null) listener.onTouchImageListener(i);
        });
